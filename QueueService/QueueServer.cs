...
namespace Tobasa
{
    class QueueServer : IDisposable
    {
        ...
        private void TCPServer_ClientClosed(NetSession ses)
        {
            ...
            string message = "[QueueServer] Client ID: " + id + " closed, RemoteInfo: " + remoteInfo + ", Client left: " + clientCount;
            Logger.Log(message);
        }
        ...
        private void TCPServer_IncomingConnection(IPEndPoint ep, out bool allow)
        {
            ...
            Console.WriteLine("Client "+lochost);
        ...
        private void TCPServer_ClientAccepted(NetSession ses)
        {
            ...
            string clientCount = clients.Count.ToString();
            string message = "[QueueServer] Client ID: " + id + " accepted, RemoteInfo: " + remoteInfo + ",  Total Client: " + clientCount;
        ...
        public void Start()
        {
                //"Data Source=C:\\desktop_app_dev\\tobasaqueue-1.5.0\\_OUTPUT\\Database\\antri.db3;Version=3;",
        ...
        private void HandleLogin(DataReceivedEventArgs arg, Client client)
        {
            ...
            try
            {
                ...
                string fcm_token = qmessage.PayloadValues["fcm_token"];
                ...
                if (!client.LoggedIn)
                {
                    ...
                    if (allowed)
                    {
                        ...
                        QueueRepository.UpdateTokenActive(client.UserName, fcm_token, post);
