...
namespace Tobasa
{
    ...
    public class NetSession : Notifier, IDisposable
    {
        ...
        public void BeginReceive()
        {
            ...
            //Console.WriteLine(_dataBuffer != null);
            ...
            _dataBuffer = new byte[8192];
            //int rec = _sock.Receive(_dataBuffer, 0, _dataBuffer.Length, 0);
            _sock.BeginReceive(_dataBuffer,0,_dataBuffer.Length,0,new AsyncCallback(ReceiveCallback),this);
            //Array.Resize(ref _dataBuffer, rec);
            //string message = Encoding.UTF8.GetString(_dataBuffer);
            //Console.WriteLine("Received: " + message);
            //Console.WriteLine(_dataBuffer);
            //Console.WriteLine(_bytesReceived);
        ...
        protected virtual void OnDataReceived()
        {
            ...
            {
                string message = String.Format("Received {0} bytes data from {1}", _dataBuffer.Length.ToString(), RemoteInfo);
                OnNotifyLog(NetSessionId, message);
