    ...
    public static class Msg
    {
        ...
        */
        public static readonly Type SysLogin = 
            CreateType("SYS", "LOGIN", "SysLogin", 4, 3, 6, 2)
        ...
        */
        ...
        /** Get Table data
        Payload     : 4th token
        Syntax GET  : SYS|GET_SMS|REQ|Identifier
        Syntax RES  : SYS|GET_SMS|RES|Identifier![json_result]
           Table     : Table name
           Endpoints : IP modem
           Username  : Username modem
           Password  : Password modem
        */
        public static readonly Type SysGetSMS =
            CreateType("SYS", "GET_SMS", "SysGetSMS", 4, 3, 0, 1)
                .AddResultPayload(0, "result");
