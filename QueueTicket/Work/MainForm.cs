    ...
    public partial class MainForm : Form
    {
        ...
        public void StartClient()
        {
            ...
            if (_client.Connected)
            {
                ...
                // SYS|LOGIN|REQ|[Module!Post!Station!Username!Password|token]
                string message =
                    Msg.SysLogin.Text +
                    Msg.Separator + "REQ" +
        ...
        void InitImages()
        {
            ...
            if (File.Exists(_settings.DisplayLogoImg))
                ...
                dispLogoImg = Properties.Resources.Logo_Puskesmas;
        ...
        private void HandleMessage(DataReceivedEventArgs arg)
        {
            try
            {
                ...
                // Handle SysLogin
                Console.WriteLine(qmessage.RawMessage);
        ...
        private void PrintPageHandler(object sender, PrintPageEventArgs ev)
        {
            ...
            StringFormat stringFormat6 = new StringFormat(stringFormat);
            ...
            Font tgl = new Font("Arial", 10, FontStyle.Regular, GraphicsUnit.Point);
            ev.Graphics.DrawString(_printJob.TimeStamp, tgl, Brushes.Black, rect2, stringFormat2);

            //yPos += printJob.DefaultFont.GetHeight(ev.Graphics);
            yPos += ev.Graphics.MeasureString(_printJob.TimeStamp, tgl, width).Height;
            ...
            yPos += ev.Graphics.MeasureString(_printJob.Footer, _printJob.DefaultFont, width).Height;
            Rectangle rect6 = new Rectangle(leftMargin, (int)yPos, width, height);
            Font lineS = new Font("Arial", 14, FontStyle.Regular, GraphicsUnit.Point);
            ev.Graphics.DrawString("-------------------", lineS, Brushes.Black, rect6, stringFormat6);
        }
