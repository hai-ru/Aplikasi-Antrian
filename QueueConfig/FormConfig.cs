...
namespace Tobasa
{
    public partial class FormServerConfig : Form
    {
        ...
        {
            { "Admin",    new ConfigFile(){ name = "AntrianAdmin",    path = ".\\AntrianAdmin\\AntrianAdmin.exe.config"  }        },
            { "Caller",   new ConfigFile(){ name = "AntrianCaller",   path = ".\\AntrianCaller\\AntrianCaller.exe.config"  }      },
            { "Display",  new ConfigFile(){ name = "AntrianDisplay",  path = ".\\AntrianDisplay\\AntrianDisplay.exe.config"  }    },
            { "Service",  new ConfigFile(){ name = "AntrianService",  path = ".\\AntrianService\\AntrianService.exe.config"  }    },
            { "Ticket",   new ConfigFile(){ name = "AntrianTicket",   path = ".\\AntrianTicket\\AntrianTicket.exe.config"  }      },
        };
        ...
        private bool ValidateTobasaModules()
        {
            ...
            {
                MessageBox.Show($"Module {moduleNames} tidak ditemukan. Tool ini harus dijalankan pada folder bundling Aplikasi Antrian",
