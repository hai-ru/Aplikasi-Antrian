...
namespace Tobasa
{
    public partial class Display : Form
    {
        ...
        public void ProcessDisplayCallNumber(string prefix, string number, string queueCount, string station, string post, bool recall = false)
        {
            ...
            // Loket or Counter
            string textCounterOrLabel = "Loket";
            ...
            if (post.Equals(post0Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post0UseLoket;
            ...
            else if (post.Equals(post1Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post1UseLoket;
            ...
            else if (post.Equals(post2Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post2UseLoket;
            ...
            else if (post.Equals(post3Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post3UseLoket;
            ...
            else if (post.Equals(post4Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post4UseLoket;
            ...
            else if (post.Equals(post5Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post5UseLoket;
            ...
            else if (post.Equals(post6Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post6UseLoket;
            ...
            else if (post.Equals(post7Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post7UseLoket;
            ...
            else if (post.Equals(post8Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post8UseLoket;
            ...
            else if (post.Equals(post9Name))
            {
                ...
                textCounterOrLabel = Properties.Settings.Default.Post9UseLoket;
            ...
            if (post == Properties.Settings.Default.StationPost)
                PlayAudio(prefix, number, _id, textCounterOrLabel);
            else if (playAudio)
                PlayAudio(prefix, number, _id, textCounterOrLabel);
        }
        ...
        private void PlayAudio(string prefix, string number, string station, string labelText)
        {
            AudioPlayer player = new Tobasa.AudioPlayer(prefix, number, station, labelText);
