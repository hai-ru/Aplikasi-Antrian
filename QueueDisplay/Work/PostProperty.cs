...
namespace Tobasa
{
    public class PostProperty
    {
        ...
        public string UseLoket { get; set; }
        ...
        public void SaveToConfiguration()
        {
            ...
            if (Id == "POST0")
            {
                ...
                settings.Post0UseLoket = UseLoket;
            }
            else if (Id == "POST1")
            {
                ...
                settings.Post1UseLoket = UseLoket;
            }
            else if (Id == "POST2")
            {
                ...
                settings.Post2UseLoket = UseLoket;
            ...
            else if (Id == "POST3")
            {
                ...
                settings.Post3UseLoket = UseLoket;
            ...
            else if (Id == "POST4")
            {
                ...
                settings.Post4UseLoket = UseLoket;
            ...
            else if (Id == "POST5")
            {
                ...
                settings.Post5UseLoket = UseLoket;
            ...
            else if(Id == "POST6")
            {
                ...
                settings.Post6UseLoket = UseLoket;
            ...
            else if (Id == "POST7")
            {
                ...
                settings.Post7UseLoket = UseLoket;
            ...
            else if (Id == "POST8")
            {
                ...
                settings.Post8UseLoket = UseLoket;
            ...
            else if (Id == "POST9")
            {
                ...
                settings.Post9UseLoket = UseLoket;
        ...
        public void LoadFromConfiguration()
        {
            ...
            if ( Id ==  "POST0" )
            {
                ...
                UseLoket = settings.Post0UseLoket;
            }
            else if (Id == "POST1")
            {
                Index = 1;
                ...
                UseLoket = settings.Post1UseLoket;
            }
            else if (Id == "POST2")
            {
                Index = 2;
                ...
                UseLoket = settings.Post2UseLoket;
            }
            else if (Id == "POST3")
            {
                Index = 3;
                ...
                UseLoket = settings.Post3UseLoket;
            }
            else if (Id == "POST4")
            {
                Index = 4;
                ...
                UseLoket = settings.Post4UseLoket;
            }
            else if (Id == "POST5")
            {
                Index = 5;
                ...
                UseLoket = settings.Post5UseLoket;
            }
            else if (Id == "POST6")
            {
                Index = 6;
                ...
                UseLoket = settings.Post6UseLoket;
            }
            else if (Id == "POST7")
            {
                Index = 7;
                ...
                UseLoket = settings.Post7UseLoket;
            }
            else if (Id == "POST8")
            {
                Index = 8;
                ...
                UseLoket = settings.Post8UseLoket;
            }
            else if (Id == "POST9")
            {
                Index = 9;
                ...
                UseLoket = settings.Post9UseLoket;
            }
            else
            {
                Index = -1;
